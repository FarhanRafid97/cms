...
>(
  (
    ...
    const toggleSidebar = React.useCallback(() => {
      return isMobile
        ? setOpenMobile((prevOpenMobileState) => !prevOpenMobileState)
    ...
    return (
      <main
        ...
        className={cn(
          ...
          'peer-data-[variant=inset]:min-h-[calc(100svh-theme(spacing.4))] md:peer-data-[variant=inset]:m-2 md:peer-data-[state=collapsed]:peer-data-[variant=inset]:ml-2 md:peer-data-[variant=inset]:ml-0 md:peer-data-[variant=inset]:rounded-[4px] md:peer-data-[variant=inset]:shadow-sm  border-linear',
          className,
        )}
        {...props}
      />
